...
number2_entry.place(x=100, y=135)

answer_entry = tk.Entry(window, width=28)
answer_entry.place(x=100, y=185)

number1 = tk.Label(window, text="Поле для ввода первого числа")
number1.place(x=100, y=50)

number2 = tk.Label(window, text="Поле для ввода второго числа")
number2.place(x=100, y=110)

answer = tk.Label(window, text="Вывод")
answer.place(x=100, y=160)
window.mainloop()